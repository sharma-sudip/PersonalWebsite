const exprerienceData = [
  {
    ...
    jobDuration: "August 2022 - June 2023",
    content: [
  ...
  },
  {
    ...
    jobDuration: "December 2018 - May 2019",
    content: [
      "Collaborated with professors and two other student assistants to conduct research on the reasons for the low graduation rate of African American students.",
      "Analyzed and visualized the graduation rate of Youngstown University students by ethnicity using Python.",
      "Conducted data collection through surveys, prepared reports and presented it to the college president.",
    ],
    styleAttributes: {
...
export default exprerienceData;
